...
<form class="layui-form" action="" id="form">
    <table width="95%" style="margin: 0 auto">
        <tr>
            ...
            <td colspan="3">
                <select name="classify" id="classify" lay-verify="required" style="height: 32px;" class="layui-input">
                    <option value=""></option>
                    <option <c:if test="${p.classify=='0'}"> selected </c:if> value="0">水果</option>
                    <option <c:if test="${p.classify=='1'}"> selected </c:if> value="1">蔬菜</option>
                    <option <c:if test="${p.classify=='2'}"> selected </c:if> value="2">其他</option>
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3"><input type="text" name="name" id="name" value="${p.name}" lay-verify="required" autocomplete="off" placeholder="名称" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right">
            ...
            <td colspan="3"><input type="text" name="num" id="num" value="${p.num}" lay-verify="float" autocomplete="off" placeholder="数量" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right">
        ...
        <tr>
            ...
            <td colspan="3"><textarea name="remark" id="remark" lay-verify="" placeholder="请输入备注" class="layui-textarea">${p.remark}</textarea></td>
        </tr>
        ...
        <tr>
            <td style="text-align: center; padding-top: 10px;" colspan="4">
                <div class="layui-form-item">
                    ...
                    <button type="button" value="1" class="layui-btn layui-btn-sm" id="submit_button" lay-submit="" lay-filter="submit_form">保存</button>
    ...
    layui.use(['form', 'layedit', 'laydate','upload'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/example/eiedata/update" ,//url
                data: $('#form').serialize(),
