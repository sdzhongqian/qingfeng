...
<form class="layui-form" action="" id="form">
    <table class="layui-table" style="width: 99%;margin: 0 auto">
        ...
        <tr>
            <td>
                <select name="classify" id="classify_1" lay-verify="required" style="height: 32px;" class="layui-input">
                    <option value=""></option>
            ...
            <td><input type="text" name="name" id="name_1" value="" lay-verify="required" autocomplete="off" placeholder="名称" class="layui-input"></td>
            <td><input type="text" name="num" id="num_1" value="" lay-verify="float" autocomplete="off" placeholder="数量" class="layui-input"></td>
            <td><input type="text" name="order_by" id="order_by_1" value="" lay-verify="number" autocomplete="off" placeholder="排序" class="layui-input"></td>
...
<script>
    ...
    layui.use(['form', 'layedit', 'laydate','upload'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/example/eiedata/saveMore" ,//url
                data: $('#form').serialize(),
    ...
    function addLine(){
        ...
        var tt = '<tr id="tr_'+index+'">';
            tt += '<td>';
            tt += '<select name="classify" id="classify_'+index+'" lay-verify="required" style="height: 32px;" class="layui-input">';
                tt += '<option value=""></option>';
                tt += '<option value="0">水果</option>';
                tt += '<option value="1">蔬菜</option>';
                tt += '<option value="2">其他</option>';
                tt += '</select>';
                tt += '</td>';
            tt += '<td><input type="text" name="name" id="name_'+index+'" value="" lay-verify="required" autocomplete="off" placeholder="名称" class="layui-input"></td>';
            tt += '<td><input type="text" name="num" id="num_'+index+'" value="" lay-verify="float" autocomplete="off" placeholder="数量" class="layui-input"></td>';
            tt += '<td><input type="text" name="order_by" id="order_by_'+index+'" value="" lay-verify="number" autocomplete="off" placeholder="排序" class="layui-input"></td>';
