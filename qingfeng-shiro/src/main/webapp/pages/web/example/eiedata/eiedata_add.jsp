...
<form class="layui-form" action="" id="form">
    <table width="95%" style="margin: 0 auto">
            ...
            <tr>
                ...
                <td colspan="3"><input type="text" name="name" id="name" value="" lay-verify="required" autocomplete="off" placeholder="名称" class="layui-input"></td>
            </tr>
            <tr>
                <td width="15%" align="right">
                ...
                <td colspan="3"><input type="text" name="num" id="num" value="" lay-verify="float" autocomplete="off" placeholder="数量" class="layui-input"></td>
            </tr>
            <tr>
                <td width="15%" align="right">
                ...
                <td colspan="3"><input type="text" name="order_by" id="order_by" value="" lay-verify="number" autocomplete="off" placeholder="排序" class="layui-input"></td>
            </tr>
            <tr>
                <td width="15%" align="right">
    ...
    layui.use(['form', 'layedit', 'laydate','upload'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/example/eiedata/save",//url
                data: $('#form').serialize(),
