...
<form class="layui-form" action="" id="form">
    <table width="95%" style="margin: 0 auto">
        <tr>
            ...
            <td colspan="3"><input type="text" name="title" id="title" value="${p.title}" lay-verify="required|field_len50" autocomplete="off" placeholder="标题" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right"><label class="layui-form-label">发布人：</label></td>
            <td><input type="text" name="publish_user" id="publish_user" value="${p.publish_user}" lay-verify="field_len50" autocomplete="off" placeholder="发布人" class="layui-input"></td>
            <td width="15%" align="right"><label class="layui-form-label">发布时间：</label></td>
            <td><input type="text" name="publish_time" id="publish_time" value="${p.publish_time}" lay-verify="field_len50" autocomplete="off" placeholder="发布时间" class="layui-input"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3"><textarea name="intro" placeholder="请输入简介" class="layui-textarea">${p.intro}</textarea></td>
        </tr>
        <tr style="padding: 10px auto">
            <td width="15%" align="right"><label class="layui-form-label_right">内容：</label></td>
            <td colspan="3">
                <script type="text/plain" id="myContent" style="width: 100%;height:500px;">${p.content}</script>
...
<script>
    ...
    layui.use(['form', 'layedit', 'laydate', 'upload'], function(){
        ...
        //初始化日期
        initDateType("publish_time",false);
        ...
        form.on('submit(submit_form)', function(data){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/common/graphic/update" ,//url
                data: $('#form').serialize(),
