...
<form class="layui-form" action="" id="form">
    <table width="95%" style="margin: 0 auto">
        <tr>
            ...
            <td colspan="3"><input type="text" name="job_name" id="job_name" lay-verify="required|field_len50" autocomplete="off" placeholder="任务名称" class="layui-input"></td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                ...
                <textarea name="notice_user" id="notice_user" placeholder="请输入备注" lay-verify="field_len500" class="layui-textarea"></textarea>
            </td>
        </tr>
        <tr>
            <td width="15%" align="right"><label class="layui-form-label">执行时间表达式：<span style="color: red">*</span></label></td>
            <td colspan="3"><input type="text" name="cron_expression" id="cron_expression" lay-verify="required|field_len50" autocomplete="off" placeholder="执行时间表达式" class="layui-input"></td>
        </tr>
        <tr>
            <td align="right"><label class="layui-form-label">任务描述：</label></td>
            <td colspan="3"><textarea name="description" placeholder="请输入任务描述" class="layui-textarea"></textarea></td>
        </tr>
        <tr>
            <td width="20%" align="right"><label class="layui-form-label">排序：</label></td>
            <td colspan="3"><input type="text" name="order_by" id="order_by" lay-verify="field_len50" autocomplete="off" placeholder="请输入排序" class="layui-input"></td>
        </tr>
        <tr>
            <td width="20%" align="right"><label class="layui-form-label">备注：</label></td>
            <td colspan="3"><textarea name="remark" id="remark" placeholder="请输入备注" lay-verify="field_len500" class="layui-textarea"></textarea></td>
        </tr>
        <tr>
            <td style="text-align: center; padding-top: 10px;" colspan="4">
                <div class="layui-form-item">
                    <input type="hidden" name="type" id="type" lay-verify="" value="${pd.type}" autocomplete="off" placeholder="请输入类型" class="layui-input">
    ...
    layui.use(['form', 'layedit', 'laydate'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/quartz/busTask/save" ,//url
                data: $('#form').serialize(),
