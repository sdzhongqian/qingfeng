...
<form class="layui-form" action="" id="form">
    <table width="95%" style="margin: 0 auto">
        <tr>
            ...
            <td colspan="3"><input type="text" name="jobName" id="jobName" lay-verify="required|field_len50" autocomplete="off" placeholder="任务名称" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right"><label class="layui-form-label">任务分组：<span style="color: red">*</span></label></td>
            <td colspan="3"><input type="text" name="jobGroup" id="jobGroup" lay-verify="required|field_len50" autocomplete="off" placeholder="任务分组" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right"><label class="layui-form-label">执行类：<span style="color: red">*</span></label></td>
            <td colspan="3"><input type="text" name="jobClassName" id="jobClassName" lay-verify="required|field_len120" autocomplete="off" placeholder="执行类" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right"><label class="layui-form-label">执行时间：<span style="color: red">*</span></label></td>
            <td colspan="3"><input type="text" name="cronExpression" id="cronExpression" lay-verify="required|field_len50" autocomplete="off" placeholder="执行时间" class="layui-input"></td>
        </tr>
        <tr>
    ...
    layui.use(['form', 'layedit', 'laydate'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/quartz/timTask/save" ,//url
                data: $('#form').serialize(),
