    ...
    <table width="95%" style="margin: 0 auto">
        <c:if test="${p.parent_name==''||p.parent_name==null}">
            <tr>
                ...
                <td colspan="3"><input type="text" readonly value="测试树表" class="layui-input"></td>
            </tr>
        </c:if>
        <c:if test="${p.parent_name!=''&&p.parent_name!=null}">
            <tr>
        ...
        <tr>
            ...
            <td colspan="3"><input type="text" name="name" id="name" value="${p.name}" lay-verify="required" autocomplete="off" placeholder="字典名称" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right">
            ...
            <td colspan="3"><input type="text" name="short_name" id="short_name" value="${p.short_name}" lay-verify="" autocomplete="off" placeholder="字典简称" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right">
            ...
            <td colspan="3"><input type="text" name="order_by" id="order_by" value="${p.order_by}" lay-verify="" autocomplete="off" placeholder="排序" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right">
    ...
    layui.use(['form', 'layedit', 'laydate','upload'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/gencode/mytree/update" ,//url
                data: $('#form').serialize(),
