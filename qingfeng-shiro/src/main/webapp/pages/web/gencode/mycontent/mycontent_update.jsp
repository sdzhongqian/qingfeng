...
<form class="layui-form" action="" id="form">
    <table width="95%" style="margin: 0 auto">
        <tr>
            ...
            <td colspan="3"><input type="text" name="title" id="title" value="${p.title}" lay-verify="" autocomplete="off" placeholder="标题" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right">
        ...
        <tr>
            ...
            <td colspan="3"><input type="text" name="content" id="content" value="${p.content}" lay-verify="" autocomplete="off" placeholder="内容" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right">
            ...
            <td colspan="3">
                <select name="order_by" id="order_by" lay-verify="" style="height: 32px;" class="layui-input">
                    <option value=""></option>
                    <option <c:if test="${p.order_by=='0'}"> selected </c:if> value="0">北京</option>
                    <option <c:if test="${p.order_by=='1'}"> selected </c:if> value="1">上海</option>
                    <option <c:if test="${p.order_by=='2'}"> selected </c:if> value="2">深圳</option>
                </select>
            </td>
        </tr>
        <tr>
    ...
    layui.use(['form', 'layedit', 'laydate','upload'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/gencode/mycontent/update" ,//url
                data: $('#form').serialize(),
