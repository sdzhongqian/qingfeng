...
<form class="layui-form" action="" id="form">
    <table class="layui-table" style="width: 99%;margin: 0 auto">
        ...
        <tr>
            ...
            <th>地区名称<span style="color: red">*</span></th>
            <th>地区简称</th>
            <th>排序</th>
            <th>备注</th>
            <th>操作</th>
        ...
        <tr>
            ...
            <td><input type="text" name="name" lay-verify="required|field_len50" autocomplete="off" placeholder="请输入地区名称" class="layui-input"></td>
            <td><input type="text" name="short_name" lay-verify="field_len50" autocomplete="off" placeholder="请输入地区简称" class="layui-input"></td>
        ...
        <tr>
            <td style="text-align: center; padding-top: 10px;" colspan="12">
                <div class="layui-form-item">
                    ...
                    <input type="hidden" name="area_cascade" value="${pd.area_cascade }"/>
...
<script>
    ...
    layui.use(['form', 'layedit', 'laydate'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/system/area/saveMore" ,//url
                data: $('#form').serialize(),
    ...
    function addLine(){
        ...
        tt += '<td><input type="text" name="name" lay-verify="required|field_len50" autocomplete="off" placeholder="请输入地区名称" class="layui-input"></td>';
        tt += '<td><input type="text" name="short_name" lay-verify="field_len50" autocomplete="off" placeholder="请输入地区简称" class="layui-input"></td>';
