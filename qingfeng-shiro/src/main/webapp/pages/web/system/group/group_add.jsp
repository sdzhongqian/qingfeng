...
<form class="layui-form" action="" id="form">
    <table width="95%" style="margin: 0 auto">
        <tr>
            ...
            <td colspan="3"><input type="text" name="name" id="name" lay-verify="required|field_len50" autocomplete="off" placeholder="组名称" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right"><label class="layui-form-label">组简称：</label></td>
            <td colspan="3"><input type="text" name="short_name" id="short_name" lay-verify="field_len50" autocomplete="off" placeholder="组简称" class="layui-input"></td>
        </tr>
        <tr>
    ...
    layui.use(['form', 'layedit', 'laydate'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/system/group/save" ,//url
                data: $('#form').serialize(),
