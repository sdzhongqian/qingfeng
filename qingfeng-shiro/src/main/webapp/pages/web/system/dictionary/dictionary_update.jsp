...
<form class="layui-form" action="" id="form">
    <table width="95%" style="margin: 0 auto">
        ...
        <tr>
            ...
            <td colspan="3"><input type="text" name="name" id="name" value="${p.name}" lay-verify="required|field_len50" autocomplete="off" placeholder="角色名称" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right"><label class="layui-form-label">字典简称：</label></td>
            <td colspan="3"><input type="text" name="short_name" id="short_name" value="${p.short_name}" lay-verify="field_len50" autocomplete="off" placeholder="角色简称" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right"><label class="layui-form-label">字典编码：</label></td>
            <td colspan="3"><input type="text" name="code" id="code" value="${p.code}" lay-verify="field_len50" autocomplete="off" placeholder="字典编码" class="layui-input"></td>
        </tr>
        <tr>
    ...
    layui.use(['form', 'layedit', 'laydate'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/system/dictionary/update" ,//url
                data: $('#form').serialize(),
