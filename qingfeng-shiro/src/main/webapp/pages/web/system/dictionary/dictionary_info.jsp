...
<form class="layui-form" action="" id="form">
    <table class="layui-table" style="width:95%;margin:10px auto;">
        ...
        <tr>
            <td align="right"><label class="layui-form-label">字典名称：<span style="color: red">*</span></label></td>
            <td colspan="3">${p.name}</td>
        </tr>
        <tr>
            <td width="16%" align="right"><label class="layui-form-label">字典简称：</label></td>
            <td colspan="3">${p.short_name}</td>
        </tr>
        <tr>
            <td width="16%" align="right"><label class="layui-form-label">字编码称：</label></td>
