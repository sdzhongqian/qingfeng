...
<form class="layui-form" action="" id="form">
    <table width="95%" style="margin: 0 auto">
        ...
        <tr>
            <td width="15%" align="right"><label class="layui-form-label">字典名称：<span style="color: red">*</span></label></td>
            <td colspan="3"><input type="text" name="name" id="name" lay-verify="required|field_len50" autocomplete="off" placeholder="字典名称" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right"><label class="layui-form-label">字典简称：</label></td>
            <td colspan="3"><input type="text" name="short_name" id="short_name" lay-verify="field_len50" autocomplete="off" placeholder="字典简称" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right"><label class="layui-form-label">字典编码：</label></td>
            <td colspan="3"><input type="text" name="code" id="code" lay-verify="field_len50" autocomplete="off" placeholder="字典编码" class="layui-input"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align: center; padding-top: 10px;" colspan="4">
                <div class="layui-form-item">
                    ...
                    <input type="hidden" name="dic_cascade" value="${pd.dic_cascade }"/>
    ...
    layui.use(['form', 'layedit', 'laydate'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/system/dictionary/save" ,//url
                data: $('#form').serialize(),
