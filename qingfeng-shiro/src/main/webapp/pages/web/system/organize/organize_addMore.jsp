...
<form class="layui-form" action="" id="form">
    <table class="layui-table" style="width: 99%;margin: 0 auto">
        ...
        <tr>
            ...
            <td><input type="text" name="name" lay-verify="required|field_len50" autocomplete="off" placeholder="请输入组织名称" class="layui-input"></td>
            <td><input type="text" name="short_name" lay-verify="field_len50" autocomplete="off" placeholder="请输入组织简称" class="layui-input"></td>
...
<script>
    ...
    function addLine(){
        ...
        tt += '<td><input type="text" name="name" lay-verify="required|field_len50" autocomplete="off" placeholder="请输入组织名称" class="layui-input"></td>';
        tt += '<td><input type="text" name="short_name" lay-verify="field_len50" autocomplete="off" placeholder="请输入组织简称" class="layui-input"></td>';
