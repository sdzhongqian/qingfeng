        ...
        <tr>
            ...
            <td colspan="3">
                <c:if test="${p.parent_name==''||p.parent_name==null}">
                    <input type="text" readonly value="组织管理" class="layui-input">
                </c:if>
                <c:if test="${p.parent_name!=''&&p.parent_name!=null}">
                    <input type="text" readonly value="${p.parent_name }" class="layui-input">
                </c:if>
            </td>
        </tr>
        <tr>
            <td width="15%" align="right"><label class="layui-form-label">组织名称：<span style="color: red">*</span></label></td>
            <td colspan="3"><input type="text" name="name" id="name" value="${p.name}" lay-verify="required|field_len50" autocomplete="off" placeholder="组织名称" class="layui-input"></td>
        </tr>
        <tr>
            <td width="15%" align="right"><label class="layui-form-label">组织简称：</label></td>
            <td colspan="3"><input type="text" name="short_name" id="short_name" value="${p.short_name}" lay-verify="field_len50" autocomplete="off" placeholder="组织简称" class="layui-input"></td>
        </tr>
        <tr>
    ...
    layui.use(['form', 'layedit', 'laydate'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/system/organize/update" ,//url
                data: $('#form').serialize(),
