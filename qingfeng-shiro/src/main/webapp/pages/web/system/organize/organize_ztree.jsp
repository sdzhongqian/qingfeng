...
<script type="text/javascript">
            ...
            success : function(res) {
                if (res.success) {
                    if(res.data.length==0){
                        treeNodes += "[{id:'0',parent_id:'parent',name:'组织管理',org_cascade:'org',level_num:'0'},";
                    }else{
                        treeNodes += "[";
                    }
    ...
    function expandFirst(){
        ...
        $("#org_cascade").val(nodes[0].org_cascade);
    ...
    function expandDefault(tree_id){
        ...
        $("#org_cascade").val(node.org_cascade);
    ...
    function zTreeOnClick(event, treeId, treeNode) {
        ...
        $("#org_cascade").val(treeNode.org_cascade);
