...
<form class="layui-form" action="${pageContext.request.contextPath}/system/user/updatePwd" id="form" lay-filter="formVal">
    <table width="90%">
        <tr>
            ...
            <td>密码可含有字母、数字，密码长度应在6~16个字符之间。</td>
        </tr>
        <tr>
            <td width="20%" align="right"><label class="layui-form-label">旧密码：<span style="color: red">*</span></label></td>
            <td><input type="password" name="old_password" id="old_password"  lay-verify="required|pass" autocomplete="off" placeholder="新密码" class="layui-input"></td>
        </tr>
        <tr>
    ...
    layui.use(['form'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/system/user/updateMyPwd" ,//url
                data: $('#form').serialize(),
