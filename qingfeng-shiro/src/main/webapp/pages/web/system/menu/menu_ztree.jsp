...
<script type="text/javascript">
    ...
    function findTreeData(tree_id){
        ...
        $.ajax({
            ...
            success : function(res) {
                if (res.success) {
                    treeNodes += "[{id:'0',parent_id:'parent',name:'菜单管理',menu_cascade:'menu',level_num:'0',tree_type:'menu'},";
    ...
    function expandFirst(){
        ...
        $("#tree_type").val(nodes[0].tree_type);
    ...
    function zTreeOnClick(event, treeId, treeNode) {
        ...
        $("#tree_type").val(treeNode.tree_type);
