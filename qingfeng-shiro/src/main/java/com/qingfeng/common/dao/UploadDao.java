...
public interface UploadDao extends CrudDao<PageData> {
     ...
     * @Date: 2019/12/4 
    **/
    void delFileByObjId(PageData pd);
    /** 
     ...
     */
    List<PageData> findFileList(PageData pd);
     ...
     */
    PageData findFileInfo(PageData pd);
